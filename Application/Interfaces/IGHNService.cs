...
public interface IGHNService
{
    ...
    Task<IReadOnlyList<GHNProvinceDto>> GetProvincesAsync();
    Task<IReadOnlyList<GHNDistrictDto>> GetDistrictsAsync(int provinceId);
    Task<IReadOnlyList<GHNWardDto>> GetWardsAsync(int districtId);
}
